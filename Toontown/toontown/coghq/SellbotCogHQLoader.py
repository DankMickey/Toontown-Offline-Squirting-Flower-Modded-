...
class SellbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def loadPlaceGeom(self, zoneId):
        ...
        if zoneId == ToontownGlobals.SellbotHQ:
            ...
            self.extra = Actor("phase_9/models/cogHQ/SellbotFactoryExterior")
            self.extra.reparentTo(self.geom)
            self.extra.setPos(615,-150,0)
            self.extra.setH(275)
            ...
            self.extra1 = Actor("phase_9/models/cogHQ/SellbotHQExterior")
            self.extra1.reparentTo(self.geom)
            self.extra1.setPos(-200,-635,0)
            self.extra1.setH(-275)
