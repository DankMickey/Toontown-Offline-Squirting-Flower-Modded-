...
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
 ...
 11200: ('to the', 'in the', 'Sellbot Factory Area'),
 ...
 13000: ('to', 'in', 'Lawbot HQ Court House Area'),
...
CashbotP = 'Cashbots'
SellbotP = 'Sellbots'
BossbotSkelS = 'a Bossbot Skeleton'
LawbotSkelS = 'a Lawbot Skeleton'
CashbotSkelS = 'a Cashbot Skeleton'
SellbotSkelS = 'a Sellbot Skeleton'
BossbotSkelP = 'Bossbot Skeletons'
LawbotSkelP = 'Lawbot Skeletons'
CashbotSkelP = 'Cashbot Skeletons'
SellbotSkelP = 'Sellbot Skeletons'
...
'CigarSmoke': ["Say NO to Tobacca!",
            "The smoke's on you!",
            "You've been bagged.",
            'How do you like the fumes?',
            'I have bad habits.',
...
'SongAndDance': ["I've been told I'm a very good dancer.",
                 "Let's dance-off!",
                 "Yout just got servered!",
                 'Surprised Toon?',
                 'I got better dance moves than you!',
                 'I hold the Toontown record in best dancer.',
                 "I like this song!",
                 "What are you going to do now?",
                 'Not even YOU can dance this good!'],
...
SkelecogInvasionBegin3 = lToonHQ + ': Skeletons have invaded the streets of Toontown!'
SkelecogInvasionUpdate1 = lToonHQ + ': Keep going Toons!'
SkelecogInvasionUpdate2 = lToonHQ + ': The Skeletons appear to be getting weaker!'
SkelecogInvasionEnd1 = lToonHQ + ': The Toons have saved the day once again!!!'
SkelecogInvasionEnd2 = lToonHQ + ': The Skeletons have retreated! Cog Production has slowed back down!'
...
BossbotRTWearWaiter = "Good Job! Now put on these waiters' suits."
...
BossbotRTCongratulations = "You did it!  You've 'fired' the C.E.O.!\x07Here, take these pink slips the C.E.O. left behind.\x07With it you'll be able to fire Cogs in a battle."
...
HolidayNamesInCalendar = {1: ('Summer Fireworks', 'Celebrate Summer with a fireworks show every hour in each playground!'),
 ...
 5: ('Skeleton Invasion', 'Stop the Skeletonss from invading Toontown!'),
