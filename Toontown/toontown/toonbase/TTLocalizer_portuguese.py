...
CogdoFlyingGameWaiting = 'Esperando por toons'
...
CogdoElevatorRewardLaff = 'Bom trabalho, Toons! Você ganha um Ponto de Risada das piadas que você salvou!'
...
CogdoExecutiveSuiteToonThankYou = 'Obrigado pelo salvamento!\x07Se você precisar de ajuda em uma batalha, use esse cartão SOS para chamar meu amigo %s!'
