...
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
 ...
 1200: ('to', 'on', 'Rue des Récifs'),
 1300: ('to', 'on', 'Allée des Marées'),
...
Tutorial = ('to to', 'in to', 'Toon-torial')
...
QuestsDefaultIncomplete = ("Comment ce Défitoon se passe, _avName_?",
 'Ca a lair que tu a encore beaucoup de travail à faire sur ce Défitoon!',
