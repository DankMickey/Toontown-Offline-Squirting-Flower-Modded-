...
class GZHoodDataAI(HoodDataAI.HoodDataAI):
    ...
    def _GZHoodDataAI__cycleLeaderBoards(self, task = None):
        messenger.send('GS_LeaderBoardSwap')
        taskMgr.doMethodLater(self.cycleDuration, self._GZHoodDataAI__cycleLeaderBoards, str(self) + '_leaderBoardSwitch')
